...
# For each of those tags gets the last $number_of_ansible_releases and builds an image
...
# Gets the last $number_of_ansible_releases and creates an image using the latest alpine image
